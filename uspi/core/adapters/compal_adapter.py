...
Compal produces server parts for DELL, HP, LENOVO, and others.
"""
...
class CompalAdapter(BaseAdapter):
    ...
    def _parse_response(self, part_number: str, html: str) -> Optional[ServerPart]:
        """解析仁宝官网 HTML 响应 / Parse Compal HTML response."""
        ...
        now = utc_now()
        return ServerPart(
            part_number=part_number, manufacturer="COMPAL", manufacturer_zh=self.name_zh,
            ...
            sources=[PriceSource(
                source_name="Compal_Official", source_name_zh="\u4ec1\u5b9d\u5b98\u7f51",
    ...
    def _mock_lookup(self, part_number: str) -> ServerPart:
        ...
        return make_mock_part(
            ...
            description=f"Compal ODM part {part_number}",
            description_zh=f"\u4ec1\u5b9d ODM \u96f6\u4ef6 {part_number}\uff08\u6a21\u62df\u6570\u636e\uff09",
        )
