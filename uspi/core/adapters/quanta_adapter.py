...
class QuantaAdapter(BaseAdapter):
    ...
    def _parse_response(self, part_number: str, html: str) -> Optional[ServerPart]:
        """解析 QCT 官网 HTML 响应 / Parse QCT HTML response."""
        ...
        now = utc_now()
        return ServerPart(
            part_number=part_number, manufacturer="QUANTA", manufacturer_zh=self.name_zh,
            ...
            sources=[PriceSource(
                source_name="Quanta_QCT", source_name_zh="\u5e7f\u8fbeQCT\u5b98\u7f51",
    ...
    def _mock_lookup(self, part_number: str) -> ServerPart:
        ...
        return make_mock_part(
            ...
            description=f"Quanta ODM part {part_number}",
            description_zh=f"\u5e7f\u8fbe ODM \u96f6\u4ef6 {part_number}\uff08\u6a21\u62df\u6570\u636e\uff09",
        )
